...
// import Testimonialsswioer from './Testimonialsswiper';
...
function Testimonials() {
  const{testimonials}=useContext(Usecontaxt)
  return (
          ...
          <div className="col-lg-9">
            <div className="testim-swiper wow fadeIn">
              ...
              <Swiper
                ...
                {...swiperOptions}
              >
                {testimonials.map((elment,ind)=>{
                  return(
                    <SwiperSlide key={ind} style={{ height: '400px' }}>
                    <div className="item ">
                        ...
                        <div className="d-flex align-items-center">
                          <div>
                            <div className="img">
                              ...
                              <img src={elment.image.url} alt="" />
                            </div>
                          </div>
                          <div className="ml-30">
                            <div className="info">
                              <h6 className="main-color">{elment.name}</h6>
